...
import static dao.StudentDao.DELETE_MARKS;
import static dao.StudentDao.DELETE_STUDENT_RECORD;
import static dao.StudentDao.INSERT_STUDENT_RECORD;
import static dao.StudentDao.SHOWMORE_STUDENT_RECORD;
import static dao.StudentDao.SHOW_STUDENT_RECORD;
import static dao.StudentDao.UPDATE_STUDENT_RECORD;
...
//            connect.close();
    ...
    public Student getStudentById(int id) {
        try {
            Connection connect = dbconnection.getconnection();
            PreparedStatement statement = connect.prepareStatement(SHOW_STUDENT_RECORD);
            statement.setInt(1, id);
            ResultSet rststudent = statement.executeQuery();
...
//                connect.close();
    ...
    public Student getStudentByName(String name){
        try {
            Connection connect = dbconnection.getconnection();
            PreparedStatement statement = connect.prepareStatement(SHOW_STUDENT_NAME);
